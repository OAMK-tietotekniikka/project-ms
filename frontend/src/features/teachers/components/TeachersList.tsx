...
const TeachersList = () => {
	...
	const updateTeacherNameMutation = useUpdateTeacher();
	...
	// Process teacher resources into structure
	...
	return (
		<div className="space-y-4">
							...
							{isEditingName ? (
								...
								<Button
									...
									onClick={() => {
										...
										setEditName(selectedTeacher?.teacher_name || "");
									}}
			...
			{/* Empty State */}
			{filteredTeachers.length === 0 && !isTeacherLoading && (
