...
export const studentService = {
	...
	updateStudent: (studentId: number, data) => apiClient.put(`/students/${studentId}`, data),
	deleteStudent: (studentId: number) => apiClient.delete(`/students/${studentId}`),
...
export const projectService = {
	...
	listStudentProjects: (studentId: number) => apiClient.get(`/students/${studentId}/projects`),
	...
	updateProjectStatus: (projectId: number, data) =>
		apiClient.put(`/projects/${projectId}/updateStatus`, data),

	updateProjectTeacher: (projectId: number, data) =>
...
export const companyService = {
	...
	addFavoriteCompanies: (data) => apiClient.post("/companies/favorites", data),
	getFavoriteCompanies: () => apiClient.get("/companies/favorites"),
	deleteFavoriteCompanies: (companyId: number) => apiClient.delete(`companies/favorites/${companyId}`),
...
export const teacherService = {
	...
	updateTeacherName: (teacherId: number, data) => apiClient.put(`/teachers/${teacherId}`, data),
